...
export function ddActivity_date_onChange(sender, args) {
...
export function ddActivity_card_onSave(layout, args) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function ddActivity_showPreview_onClick(sender, args) {
    return __awaiter(this, void 0, void 0, function () {
        var layout;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, showPreview(layout, args)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
export function ddActivity_memberSent_onChange(sender) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
export function ddActivity_cityRef_onChange(sender) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
